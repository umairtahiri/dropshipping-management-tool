export const colorsList: any = {
  multi:
    "linear-gradient(90deg, #f945b1 0.36%, #7500af 16.86%, #ee4023 31.86%, #ffa400 54.12%, #ffd700 62.86%, #57ab5a 79.36%, #81d1e0 95.86%)",
  metallic: "#d6d6d6",
  "100 mph": "#c93f38",
  ...
  "90% cocoa": "#3d1c02",
  "a bloomed cherry blossom": "#ffccda",
